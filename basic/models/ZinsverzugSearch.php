...
/**
 * ZinsverzugSearch represents the model behind the search form about `app\models\Zinsverzug`.
 */
class ZinsverzugSearch extends Zinsverzug
{
    /**
     * @inheritdoc
     */
