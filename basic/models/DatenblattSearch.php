...
class DatenblattSearch extends Datenblatt
{
    ...
    public function rules()
    {
        return [
            ...
            [['kaeufer', 'kaeufer_debitornr', 'kaeufer_email', 'kaeufer_festnetz', 'kaeufer_handy', 'kaeufer_titel','kaeufer_nachname', 'kaeufer_vorname', 'kaeufer_titel2','kaeufer_nachname2', 'kaeufer_vorname2', 'sap_debitor_nr', 'intern_debitor_nr'], 'safe'],
